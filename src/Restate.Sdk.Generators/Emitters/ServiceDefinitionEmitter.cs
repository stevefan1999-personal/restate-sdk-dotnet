        ...
        foreach (var service in services)
        {
            ...
            foreach (var handler in service.Handlers)
            {
                ...
                var deserializerExpr = handler.InputTypeFullName is not null
                    ? $"static (data) => {{ var r = new global::System.Text.Json.Utf8JsonReader(data); return global::System.Text.Json.JsonSerializer.Deserialize<{handler.InputTypeFullName}>(ref r, global::Restate.Sdk.JsonSerde.SerializerOptions); }}"
                    : "null";
